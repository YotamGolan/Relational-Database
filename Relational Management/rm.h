...
#define INDEXES_RECORD_DATA_SIZE 1 + INDEXES_COL_TABLE_NAME_SIZE * 3
...
private:
  ...
  static string getFileName(const string &tableName, const string &attributeName);
  ...
  void prepareIndexesRecordData(const string &tableName, const string &attributeName, void *data);
